...
Isadmin=$(curl -sS https://raw.githubusercontent.com/rezakojexs/permission/main/ipmini | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/rezakojexs/permission/main/ipmini | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/rezakojexs/update/main/install_up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/rezakojexs/update/main/version_up)
...
serverV=$( curl -sS https://raw.githubusercontent.com/rezakojexs/update/main/version_up)
if [ "$Isadmin" = "ON" ]; then
